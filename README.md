...
__[CLICK HERE FOR A LIVE DEMO](https://rubenholthuijsen.nl/geolet/demo)__
...
#### popup
This contains the `L.Popup` object that will be bound to the marker that is added to the map when geolocation is activated. It is generated once the control is added to a map. I would recommend against completely replacing this, as doing so will not remove an popup marker from the map.
